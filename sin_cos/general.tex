...
\input{arco_angulo.tex}
\input{identidad_coseno.tex}
\input{demostracion_geometrica.tex}
\input{deduccion_rotacion.tex}
\input{demostracion_formula_coseno.tex}
\input{complejos_matriz.tex}
\input{ejemplo_rotacion.tex}
\input{demostracion_coseno_aureo.tex}
\input{chebyshev_fibonacci.tex}
