...
\begin{tikzpicture}[scale=1.5]
  ...
  \draw[->] (0,-0.3) -- (0,3.8) node[above] {$\arccos(x)$};
  
  % Etiquetas de los ejes
  \draw (-1,-0.1) -- (-1,0.1) node[below] {$-1$};
  \draw (1,-0.1) -- (1,0.1) node[below] {$1$};
  \draw (-0.1,{acos(-1)*pi/180}) -- (0.1,{acos(-1)*pi/180}) node[left] {$\pi$};
  \draw (-0.1,{acos(0)*pi/180}) -- (0.1,{acos(0)*pi/180}) node[left] {$\frac{\pi}{2}$};
  
  % Gráfica del arcocoseno (curva suave usando plot)
  \draw[blue, thick, domain=-1:1, samples=100] 
    plot (\x, {acos(\x)*pi/180});
  
  % Puntos importantes
  \fill[red] (-1,{acos(-1)*pi/180}) circle (1.5pt);
  \fill[red] (0,{acos(0)*pi/180}) circle (1.5pt);
  \fill[red] (1,{acos(1)*pi/180}) circle (1.5pt);
  
  % Etiquetas de puntos
  \node[above right] at (-1,{acos(-1)*pi/180}) {$(-1,\pi)$};
  \node[above right] at (0,{acos(0)*pi/180}) {$(0,\frac{\pi}{2})$};
  \node[above right] at (1,{acos(1)*pi/180}) {$(1,0)$};
\end{tikzpicture}
\end{center}
